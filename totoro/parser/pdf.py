...
from totoro.vision import OCR, Recognizer, LayoutRecognizer, TableStructureRecognizer
...
class OpenDocPdfParser:
    ...
    def _merge_with_same_bullet(self):
        ...
        while i + 1 < len(self.boxes):
            ...
            if b["text"].strip()[0] != b_["text"].strip()[0] \
                    ...
                    or self.tokenizer.is_chinese(b["text"].strip()[0]) \
                    or b["top"] > b_["bottom"]:
                i += 1
                continue
            b_["text"] = b["text"] + "\n" + b_["text"]
    ...
    def _extract_table_figure(self, need_image, ZM,
        ...
        while i < len(self.boxes):
            ...
            if not self.tbl_det.is_caption(c):
                i += 1
                continue
